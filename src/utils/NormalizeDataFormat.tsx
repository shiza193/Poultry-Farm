 ...
 * @param expectedType 'object' | 'array' (what your code expects)
...
export const normalizeDataFormat = (
  ...
  if ((expectedType === 'object' && isObject) || (expectedType === 'array' && isArray)) {
    return data;
  }

  // Show toast about format change
  showErrorToast(
    `${label} format changed! Expected ${expectedType}, got ${isArray ? 'array' : 'object'}.`
  );
